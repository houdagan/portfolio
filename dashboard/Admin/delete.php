...
if($_SERVER['REQUEST_METHOD'] == "GET"){ 
    ...
    try{
        if(isset($_GET['id_poject'])){
            $id_poject = (int)($_GET['id_poject']);
            $query = "DELETE FROM projet WHERE id_poject = $id_poject";
    ...
    <div class="container">
        ...
        <table class="table" border="1" >
            ...
            <tr id="<?=$item['id_poject']; ?>">
                ...
                <a href="delete.php?id_poject=<?=$item['id_poject']; ?>" style="color: blue; padding-left: 100px" >delete</a></td>
            </tr>
            <?php endforeach;?>
            </tbody>
        </table>
